...
import { SECRET_ADMIN_BLOG_PATH, SECRET_ADMIN_REPORTS_PATH, SECRET_ADMIN_VIDEOS_PATH } from "@/lib/admin/paths";
    ...
    <div className="w-full">
      <section className="w-full bg-gradient-to-br from-red-50 to-rose-100 py-14 sm:py-20">
        <div className="mx-auto max-w-5xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <p className="mt-4 text-xl text-gray-700">لوحة إدارة المقالات والبلاغات وتحليلات الفيديو.</p>
        </div>
      </section>
      ...
      <section className="w-full bg-white py-14 sm:py-20">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            ...
            <div className="rounded-3xl border border-gray-200 bg-gray-50 p-10">
              <h2 className="text-3xl font-bold text-gray-900">تحليلات الفيديو</h2>
              <p className="mt-3 leading-relaxed text-gray-700">مشاهدات الفيديو، نسب الإكمال، وأداء المشاركة.</p>
              <div className="mt-8 flex gap-4">
                <Link
                  href={SECRET_ADMIN_VIDEOS_PATH}
                  className="inline-flex items-center justify-center rounded-lg bg-red-700 px-8 py-3 font-semibold text-white transition-colors hover:bg-red-800"
                >
                  فتح التحليلات
                </Link>
