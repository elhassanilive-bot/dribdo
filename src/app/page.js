...
const heroHighlights = [
  'منشورات ومرئيات تترتب بأناقة في شريطك الرئيسي',
  'ملف شخصي ينسج تفاصيل حضورك ويعبر عن ذاتك',
  'بريد وارد ينظم نبضات التواصل والرسائل الوافدة',
  'سيادة كاملة على خصوصية حسابك وراحة بالك',
];
...
const everydayUses = [
  ...
  {
    title: 'شريط متدفق بالجمال',
    text: 'يعرض الشريط الرئيسي منشورات من تتابعهم بسلاسة وهدوء. تفاعل مع ما يلامس قلبك، اترك تعقيباً لطيفاً، أو امضِ بسلام نحو أفكارٍ أخرى تهمك.',
  },
  {
    title: 'عالمٌ من المرئيات المتدفقة',
...
const privacyItems = [
  'حدّد جمهور منشوراتك بدقة قبل النشر أو اجعل خيارك الافتراضي ثابتاً.',
  'اختر من يستحق إرسال التعقيبات أو الإشارة إليك في الكلمات.',
  'اضبط إعدادات التواصل وحدّد من يمكنه إرسال طلبات مراسلة إلى صندوقك.',
  'توارى عن الأنظار وأخفِ حالة نشاطك متى ما رغبت في التصفح الهادئ.',
];

const inboxItems = [
  {
    title: 'نبضات الإشعارات',
  ...
  {
    title: 'أروقة الدردشة',
    text: 'بعد تلاقي الأفكار وقبول الطلب، تنطلق محادثة ثنائية مباشرة ومرتبة مع الحفاظ على مرونة التواصل.',
  },
];
    ...
    <main dir="rtl" className="min-h-screen bg-[#f8f4ef] text-black">
        ...
        <div className="relative mx-auto grid max-w-6xl gap-5 px-4 py-8 sm:px-5 sm:py-10 lg:grid-cols-[1fr_0.82fr] lg:px-6 lg:py-12">
          <div className="flex flex-col justify-center text-right">
            ...
            <h1 className="mt-4 max-w-3xl text-[1.75rem] font-black leading-[1.18] text-black sm:text-3xl lg:text-4xl">
              دريبدو مساحتك الخاصة للنشر، والمشاهدة، والتواصل بالطريقة التي تناسبك.
            </h1>
      ...
      <section className="mx-auto max-w-6xl px-4 py-7 sm:px-5 sm:py-8 lg:px-6">
        <SectionHeading
          ...
          title="أقسامٌ واضحة تنسجم مع يومك"
      ...
      <section className="bg-[#111827] py-7 sm:py-8 text-white">
        <div className="mx-auto max-w-6xl px-4 sm:px-5 lg:px-6">
          <SectionHeading
            ...
            text="نمنحك تجربة تصفح هادئة؛ حيث تترتب مساحات الصور والفيديوهات تلقائياً لمنع أي قفزات مفاجئة في الواجهة، لتظهر الوسائط بانسيابية تامة حسب سرعة شبكتك."
            dark
          />
          <div className="mt-4 grid gap-3 md:grid-cols-3">
            <article className="rounded-[1.25rem] bg-white/8 p-4 sm:p-4 text-right">
              ...
              <p className="mt-2 text-[12px] leading-5 sm:text-[13px] sm:leading-6 text-white/68">تنساب الصور برقة في شريط النشر، وفي أرجاء ملفك الشخصي والاستكشاف دون تشويه للأبعاد.</p>
            </article>
            <article className="rounded-[1.25rem] bg-white/8 p-4 sm:p-4 text-right">
            ...
            <article className="rounded-[1.25rem] bg-white/8 p-4 sm:p-4 text-right">
              ...
              <p className="mt-2 text-[12px] leading-5 sm:text-[13px] sm:leading-6 text-white/68">تظهر الرموز الشخصية للمستخدمين بخفة وتناسق في التعليقات والدردشات وكافة أرجاء المنصة.</p>
            </article>
          </div>
        </div>
      </section>
